...
//         body_ball->move_and_collide(ball_direction * ball_speed * delta);
...
//             if (collision_info->get_collider() == body_ai ||
//                 collision_info->get_collider() == body_player) {
//                 ball_direction.x = collision_info->get_normal().x;
//                 ball_direction.y =
//                     godot::Vector2(collision_info->get_collider()->get("global_position"))
//                         .direction_to(body_ball->get_global_position())
//                         .y;
...
//         body_ai->get_global_position().direction_to(body_ball->get_global_position());
//     ai_to_ball_dir.x = 0;
